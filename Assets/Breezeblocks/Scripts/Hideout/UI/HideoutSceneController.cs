...
public sealed class HideoutSceneController : MonoBehaviour
{
    ...
    /// <summary>
    /// Shows the selected fence item inside the shared equipment context panel.
    /// </summary>
        ...
        int reserveAmmo)
    {
        ...
        EquipmentSlotType resolvedSlotType = item is ArmorData ? EquipmentSlotType.Armor : slotType;
        fencePanel.contextPanel.ShowContextForItem(item, resolvedSlotType, projectile, loadedAmmo, reserveAmmo);
    }
