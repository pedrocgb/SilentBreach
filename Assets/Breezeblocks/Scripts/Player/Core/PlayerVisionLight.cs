...
public class PlayerVisionLight : MonoBehaviour
{
    ...
    private bool _mouseLookSuppressed;
    ...
    /// <summary>
    /// Suppresses automatic mouse-look updates without fully blocking the vision component.
    /// </summary>
    public void SetMouseLookSuppressed(bool suppressed)
    {
        _mouseLookSuppressed = suppressed;
    }
