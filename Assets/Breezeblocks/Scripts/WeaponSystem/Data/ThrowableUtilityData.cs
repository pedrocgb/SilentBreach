...
public class ThrowableUtilityData : UtilityItemData
{
    ...
    [FoldoutGroup("Throwable/Direct Damage"), ShowIf(nameof(UsesDirectDamage))]
    [SerializeField] private bool directHitIsLethal = true;
    ...
    [SerializeField] private bool explosionIsLethal = true;
    ...
    public bool DirectHitIsLethal => directHitIsLethal;
    ...
    public bool ExplosionIsLethal => explosionIsLethal;
    ...
    /// <summary>
    /// Clamps throwable authoring values and validates nested audio settings in inspector.
    /// </summary>
